...
extern "C"
{
    ...
    typedef IOTHUB_CLIENT_RESULT(*pfpfIoTHubTransport_GetDeviceTwin)(IOTHUB_DEVICE_HANDLE handle, IOTHUB_TRANSPORT_GET_DEVICE_TWIN_CALLBACK completionCallback, void* callbackContext);
